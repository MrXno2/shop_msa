from shop_msa.srv_payment.src.services.rabbit_payment_order import RabbitPaymentAuthService, RabbitPaymentOrderService
from srv_payment.src.rabbit.rabbit import RabbitMain
