...
from srv_auth.src.main import app

from core_app.settings import settings

TEST_DATABASE_URL = make_test_database_url(
    settings.POSTGRES_URL_SERV_AUTH, "shop_auth_test"
)
...
def mock_rabbit_publish(monkeypatch):
    ...
    monkeypatch.setattr("srv_auth.src.modules.auth.service.rabbit_payment_auth", mock)
    return mock
